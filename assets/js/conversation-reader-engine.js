...
(function (root) {
  ...
  var PATTERNS = {
    ...
    threat: [words(["i(?:[’']ll| will) (?:hurt|kill|hit|ruin|destroy|end) you", "you(?:[’']ll| will) regret (?:this|it)", "you(?:[’']ll| will) be sorry", "i(?:[’']ll| will) make you (?:pay|sorry|regret)", "i know where you (?:are|live|work)", "watch your back", "or else", "i(?:[’']ll| will) find you", "i(?:[’']ll| will) take (?:the kids|the children|your kids|them) (?:away|from you)?", "you(?:[’']ll| will) never see (?:the kids|the children|them|your kids) again", "if you (?:leave|go|tell anyone)[^.!?]{0,40}(?:i(?:[’']ll| will)|you(?:[’']ll| will) never)", "i(?:[’']ll| will) (?:post|send|share|show everyone) (?:your|the|those) (?:photos|pictures|messages|videos)", "i(?:[’']ll| will) tell everyone"])],
  ...
  function nextMove(r) {
    ...
    } else if (r.level === 'hot' || (r.trend === 'rising' && r.level !== 'calm')) {
